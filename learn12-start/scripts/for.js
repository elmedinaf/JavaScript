...
let bottlesSong = '';
for (let i = 99; i >= 1; i--) {
bottlesSong += i + " bottles of beer on the wall, " + i + " bottles of beer. Take one down, pass it around, " + (i - 1) + " bottles of beer on the wall.<br>";}
document.getElementById("beer").innerHTML = bottlesSong;
...
// print the results in the for-of paragrap
const myString = "Mochi";
let lettersList = '';
